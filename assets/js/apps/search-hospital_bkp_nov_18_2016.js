...
var list = '             <li class="wow slideInUp result-border">' +
            ...
            '                                                               <div class="col-sm-8">  Attesa: <b  class="color-neon">' + item.official_waiting_days + 'giomi</b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" data-toggle="popover" data-placement="top" title="Info" data-html="true" data-content="<a target=\'_blank\' href=\''+parseUrl(item.source)+'\'>'+item.source+'</a> "><i class="fa fa-info-circle" aria-hidden="true"></i></a></div>' +
            '                                                           </div>' +
            '                                                           <div>' +
