			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="blue-wrapper">
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="google-map wow slideInUp" style="width:348px;height:383px;" >
									<?php 
								$exam_ids = array();
								...
								if ($exam_ids) {
								 ...
								 ?>
								  <iframe src="/map_iframe.php?exam_ids=<?=$exam_ids_string?>" frameborder="0" scrolling="no" width="320" height="350"></iframe> 
								</div>
