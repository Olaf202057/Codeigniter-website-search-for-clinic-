 ...
 function resultHTML(structures) {
     ...
     $.each(structures, function(i, item) {
         ...
         var list = '<li class="wow slideInUp">' +
             ...
             '			<a href="'+base_url+'hospitals/'+item.id+'?exam_id='+item.exam_id+'"><img class="img-responsive" src="' + item.imageurl + '" />' +'</a>'+
             '		</div>' +
             '	</div>' +
             '	<div class="col-sm-9">' +
             '  <div class="col-sm-12">'+
             '      <div><a href="'+base_url+'hospitals/'+item.id+'?exam_id='+item.exam_id+'"><strong>' + item.hospital + '</strong></a></div>'+
             ...
             '                       <a href="' + item.website + '" target="_blank" class="btn btn-default"  style="font-size: 11px;">Vai al sito</a>'+
             '                  </div>'+
             '              </div>'+
             '   </div>'+
             '	</div>' +
