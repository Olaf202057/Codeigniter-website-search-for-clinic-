        ...
        <div class="row">
            <form class="form-horizontal col-md-6" method="post"  role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="telephone" id="telephone" value="" placeholder="telephone" class="form-control" maxlength="10" >
                    </div>
                </div>
                <div class="form-group">
...
$(document).on('keydown', '#telephone,#fax', function(e) {
    ...
    $('#add_hospital').on('click',function(){
            ...
            var ext_a           = image.substring(ads_image.lastIndexOf('.') + 1);
