...
<div class="spacer">
    <div class="container">
        ...
        <div class="row">
			<div class="col-md-12"><a href="<?php echo $last_hospital_index_url; ?>" class="btn btn-success pull-left">Back to hospitals</a></div>
            <form class="form-horizontal col-md-6" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="email" value="<?php echo  $hospital->email; ?>"class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="region" value="<?php echo  $hospital->region; ?>"class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="latitude" value="<?php echo $hospital->latitude; ?>"class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="longitude" value="<?php echo  $hospital->longitude; ?>"class="form-control">
