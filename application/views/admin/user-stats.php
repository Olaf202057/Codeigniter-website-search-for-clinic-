         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-sm-6 col-md-6 col-lg-6 text-right">
                <a href="<?php echo base_url().'admin/'; ?>" style="margin:21px 15px 0 0" class="btn btn-primary btn-sm">Back</a>
               ...
               <div class="col-sm-12 col-md-12 col-lg-12 wow fadeInDown" data-wow-delay="0s">
                  <div class="counting-box">
                     <div class="box borderless">
                        <strong> <?php  if($impresion[0]['clicks'] != '' && $impresion[0]['clicks'] > 0){ echo $impresion[0]['clicks'] ;} else echo "0"; ?></strong><br/>
                        <!-- Interactions -->
                        Clicks
                     </div>
                     <div class="box">
                     ...
                     <div class="box">
                        <strong><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $price; ?></strong><br/>
                        Avg. Cost
                     </div>
                     <div class="box">
                        <strong><i class="fa fa-inr" aria-hidden="true"></i><?php if($impresion[0]['budget_amount'] != '' &&  $impresion[0]['budget_amount'] > 0){ echo $impresion[0]['budget_amount'] ;} else echo "0,000"; ?></strong><br/>
                        Cost
                     </div>
                  </div>
               </div>
               ...
               <div class="margin-10">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12 pad-10- wow fadeInDown" data-wow-delay="0s">
                     <div class="table-responsive">
                        <div class="table-title">
                           <i class="fa fa-pencil"></i> Good quality but low traffic keywords (6) 
                           <!-- <span class="pull-right"><button type="button" class="btn btn-xs"><i class="fa fa-caret-down" aria-hidden="true"></i></button> <button type="button" class="btn btn-xs"><i class="fa fa-minus" aria-hidden="true"></i></button> <button type="button" class="btn btn-xs"><i class="fa fa-remove" aria-hidden="true"></i></button></span> -->
                           <div class="clearfix"></div>
                        </div>
                                      ...
                                      $cpc = 0.00;
                                        ...
                                        if(count($getReview)>0)
                                        {
                                          if($getReview[0]['count(exam_id)']!=0)
                                          {
                                            ...
                                            $cpc1 = ($res['ad_rank']/$quality_score)+0.01;
                                            $cpc =number_format((float)$cpc1, 2, '.', '');
                                          }
                                        }
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      <?php 
         ...
         $getExam = $this->master_model->getRecords('tbl_click_datewise',array('tblexamination.owner_id'=>$user_id));
