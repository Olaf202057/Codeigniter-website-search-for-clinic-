               ...
               <tr>
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td>
                             <h3>Gentile <?php echo $user_name; ?>,</h3>
                              <div class="text-thk">Potrà accedere alla Tua area personale dopo che la Sua Email verrà verificataed il Suo Account confermato. Ecco un riepilogo delle Sue informazioni:</div>
                         ...
                         <table align="center" style="font-size:13px; font-weight:bold;padding-right: 10px;color:#00000;" border="1">
                           <tr>
                            ...
                            <tr>
                              ...
                              <td  width="150"><?php echo $password;?></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                              <td width="150"><b>Modalità di pagamento : </b></td>
                              <td width="150"><?php echo $pay_method;?></td>
                           </tr>
                           <tr>
                              <td width="150"><b>Totale : </b></td>
                        ...
                        <tr>
                           <td>
                              <div class="buton-act"><a href="<?php echo base_url()."verify/".md5($email);?>">Verifica il mio account</a></div>
                           </td>
                        </tr>
                        <tr>
                           <td>&nbsp;</td>
