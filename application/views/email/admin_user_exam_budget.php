                  ...
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td>
                             <h3>Hi Admin,</h3>
                              <div class="text-thk">  </div>
                            <?php echo $user_name." ".$message;?>
                           </td>
                        </tr>
                        <tr >
                        ...
                        <td colspan='6'>
                         ...
                         <table align="center" style="font-size:13px; font-weight:bold;padding-right: 10px;color:#00000;" border="1">
                            ...
                            <?php if($msg == 'add' || $msg == 'add_csv')
                              { ?>
                             <tr>
                               <td  width="150"><b>Hospital : </b></td>
                               <td  width="150"><?php echo $hospital;?></td>
                             </tr>
                            <?php } ?>
                             <tr>
                             ...
                             <?php if($msg != 'add_csv'){?>
                             <tr>
                               <td  width="150"><b>Exam type : </b></td>
                               <td  width="150"><?php echo $exam;?></td>
                             </tr>
                             <?php } ?>
