               ...
               <tr>
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td>
                             <h3>Dear <?php echo 'Admin'; ?>,</h3>
                              <div class="text-thk">New Contact Enquiry on Medscanner. Following are the details:</div>
                        ...
                        <td colspan='6'>
                         ...
                         <table align="center" style="font-size:13px; font-weight:bold;padding-right: 10px;color:#00000;" border="1">
                           <tr>
                              ...
                              <td  width="150"><?php echo ucfirst($firstname).' '.ucfirst($lastname);?></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             <td  width="150"><b>Contact Number : </b></td>
                             <td  width="150"><?php echo $contactnum;?></td>
                           </tr>
                           <tr>
