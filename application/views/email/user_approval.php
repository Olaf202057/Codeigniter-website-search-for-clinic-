               ...
               <tr>
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td>
                             <h3>Dear <?php echo ucfirst($user_name); ?>,</h3>
                            <!--   <div class="text-thk">User Approval From Admin.</div> -->
                        ...
                        <td colspan='6'>
                           <br/>
                              <div class="text-thk"><?php echo "Congratulations, You are approved by admin."; ?></div>
                        </td>
                        </tr>
