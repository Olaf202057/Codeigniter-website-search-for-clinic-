                  ...
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <td style="padding: 10px;"><a href="<?php echo base_url(); ?>" class="logo-w"><img src="<?php echo base_url().'assets/images/' ?>logo.png"  alt="logo"  height="" /></a></td>
                                <td align="right" style="font-size:13px; font-weight:bold;padding-right: 10px;color:#fff;"><?php echo date("Y-m-d"); ?></td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
                        ...
                        <tr>
                           <td>
                             <h3>Dear Admin,</h3>
                              <div class="text-thk">New Hospital Registration on Medscanner</div>
                        ...
                        <td colspan='6'>
                         ...
                         <table align="center" style="font-size:13px; font-weight:bold;padding-right: 10px;color:#00000;" border="1">
                           <tr>
                              ...
                              <td width="150">Hospital Name</td>
                              <td  width="150"><?php echo $hospital_name;?></td>
                           </tr>
                            <tr>
                        ...
                        <!-- <tr>
                           <td>
                              <div class="buton-act"><a href="#">Verifica il mio account</a></div>
                           </td>
                        </tr> -->
                        <tr>
                           <td>&nbsp;</td>
                        ...
                        <tr>
                           <td style="text-align:center; color:#aeaeae;background-color:#02304f; padding-bottom:10px;"> Copyrights © <?php echo date("Y"); ?> by<span style="color:#fff;"><a href="<?php echo base_url(); ?>" style="decoration:none;"> Medscanner</a></span> All Rights Reserved. </td>
                        </tr>
                     </table>
                  </td>
               </tr>
