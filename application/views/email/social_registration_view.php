               ...
               <tr>
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td>
                             <h3>Dear <?php echo ucfirst($first_name).' '.ucfirst($last_name); ?>,</h3>
                              <div class="text-thk">Your registration has been done successfully on Medscanner.</div>
                        ...
                        <tr>
                           <td style="text-align:center; color:#aeaeae;background-color:#02304f; padding-bottom:10px;"> Copyrights © <?php echo date("Y"); ?> by<span style="color:#fff;"> Medscanner</span> All Rights Reserved. </td>
                        </tr>
                     </table>
                  </td>
               </tr>
