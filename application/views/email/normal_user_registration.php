                        ...
                        <tr>
                           <td>
                             <h3>Gentile <?php echo $user_name; ?>,</h3>
                              <div class="text-thk">Grazie per essersi registrato su Medscanner. <?php if($type == 'normal'){ ?>Potrà accedere alla Tua area personale dopo che la Sua Email verrà verificataed il Suo Account confermato. Ecco un riepilogo delle Sue informazioni: <?php } ?></div>
