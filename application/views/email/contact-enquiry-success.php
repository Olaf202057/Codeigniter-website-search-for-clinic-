               ...
               <tr>
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td>
                             <h3>Dear <?php echo ucfirst($firstname).' '.ucfirst($lastname); ?>,</h3>
                              <div class="text-thk">Thank you for contacting Medscanner.Your request for contact enquiry has been sent successfully.</div>
                        ...
                        <tr>
                           <td style="text-align:center; color:#aeaeae;background-color:#02304f; padding-bottom:10px;"> Copyrights © 2016 by<span style="color:#fff;"><a style="decoration:none;" href="<?php echo base_url(); ?>"> Medscanner</a></span> All Rights Reserved. </td>
                        </tr>
                     </table>
                  </td>
               </tr>
