      ...
      <div class="col-sm-3 col-md-3 col-lg-3">
         ...
         <div class="left-section">
            ...
            <div class="left-sidebar">
               ...
               <ul>
                  <li>
                     <div class="head-title"><a href="#">Tutti esame</a></div>
                     <ul>
                   ...
                   <?php if(count($examination)>0)
                         {
                           ...
                           { ?>
                         <li class="<?php if($exam['examination_id']==$exam_id)echo 'act'; ?>"><a href="javascript:void(0);" class="getid" data-id="<?php echo $exam['examination_id'];?>"><i class="fa fa-search" aria-hidden="true"></i><?php echo $exam['exam_type'];?></a></li>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 text-right">
                     <select class="selectpicker select-dropdown history-select" data-size="5" style="display: none;" name="duration" id="duration" >
                      ...
                      <option  value="last_15"  <?php if($date_range =='last_15')  echo "selected" ; ?>>Ultimi 15 giorni:: <?php echo date('d M Y', strtotime('-15 days'));?> -  <?php echo date('d M Y');?></option>
                  ...
                  <div class="margin-10">
                     ...
                     <div class="col-sm-12 col-md-12 col-lg-12 pad-10- wow fadeInDown" data-wow-delay="0s">
                        <div class="table-responsive">
                           <div class="table-title">
                              <i class="fa fa-pencil"></i>Risultati per esame  
                              <span class="pull-right"><!-- button type="button" class="btn btn-xs"><i class="fa fa-caret-down" aria-hidden="true"></i></button> <button type="button" class="btn btn-xs"><i class="fa fa-minus" aria-hidden="true"></i></button> <button type="button" class="btn btn-xs"><i class="fa fa-remove" aria-hidden="true"></i></button> --></span>
                              <div class="clearfix"></div>
                           </div>
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      <?php 
         ...
         $getExam = $this->master_model->getRecords('tbl_click_datewise',array('tblexamination.owner_id'=>$this->session->userdata('user')->id,'exam_id'=>$exam_id));
