			...
			<div class="panel-body">
				<table class="table table-striped table-filter">
					<tbody>
						...
						<tr>
							<td>€ 0 - € 50</td>
							<td><div class="checkbox"><label> <input class='filter-search checkbox-price' data-min="0" data-max="50" type="checkbox"></label></div></td>
						</tr>
						<tr>
							<td>€ 50 - € 100</td>
							<td><div class="checkbox"><label> <input class='filter-search checkbox-price' data-min="50" data-max="100" type="checkbox"></label></div></td>
						</tr>
						<tr>
							<td>€ 100 - € 300</td>
							<td><div class="checkbox"><label> <input class='filter-search checkbox-price' data-min="100" data-max="300" type="checkbox"></label></div></td>
						</tr>
						<tr>
							<td>€ 300</td>
							<td><div class="checkbox"><label> <input class='filter-search checkbox-price' data-min="0" data-max="999999" type="checkbox"></label></div></td>
						</tr>
					</tbody>
				</table>
			</div>
