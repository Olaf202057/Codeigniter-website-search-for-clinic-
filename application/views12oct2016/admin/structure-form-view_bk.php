    ...
    <div class="container">
        ...
        <div class="row">
            <form class="form-horizontal col-md-6" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Latitude</label>
                    <div class="col-sm-9">
                        <input type="text" name="latitude" value="<?php echo  $hospital->latitude; ?>" placeholder="Latitude" class="form-control" >
                        <span class="text-danger"><?php echo form_error('latitude'); ?></span>
                    </div>
                </div>
                <div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Longitude</label>
                    <div class="col-sm-9">
                        <input type="text" name="longitude" value="<?php echo  $hospital->longitude; ?>" placeholder="Longitude" class="form-control" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email"  value="<?php echo  $hospital->email; ?>"class="form-control">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <img style="width:100%;" src="<?php echo  $hospital->image_url; ?>" >
