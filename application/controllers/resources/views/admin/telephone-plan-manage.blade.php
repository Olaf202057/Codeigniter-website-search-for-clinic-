...
<div class="page-title">
    <div>
        <h1> <i class="fa fa-phone"></i> Telephone Broadcast</h1>
        <h4>Telephone Broadcast</h4>
    </div>
</div>
<!-- END Page Title -->
...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li  class="active" >Telephone Broadcast</li>
    </ul>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title"><h3> <i class="fa fa-phone"></i>Telephone Broadcast</h3></div>
                ...
                <div class="box-content">
                    ...
                    <div class="btn-toolbar pull-right clearfix">
                        <div class="btn-group"> 
                            ...
                            --> <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="Refresh" href="{{ url('/') }}/superadmin/plan/telephone" style="text-decoration:none;"><i class="fa fa-repeat"></i></a> 
                            ...
                            @if(count($plan)>0)
                                @foreach($plan as $plan)
                                        <?php 
                                         ...
                                         if($i==1){ ?>
                                        <tr>
                                             <td colspan="7" > <b>Plan For USA</b></td>
                                        </tr>
                                        <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip set_chnnenel" style="text-decoration:none;"  href="javascript:void(0);"  data-type="<?php echo $loc ; ?>" data-target="#modal1" data-toggle="modal" data-planid="{{ $plan['plan_id'] }}" data-planmem="{{ $plan['channels'] }}"  data-planprice="{{ $plan['price'] }}"   title="Edit"><i class="fa fa-edit"></i></a>
                                        ...
                                        <?php if($i==4){ ?>
                                            <tr>
                                                 <td colspan="7" > <b>Plan For Canada</b></td>
                                            </tr>
                                        <?php } $i++; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 id="myModalLabel2"><b>Update Telephone Broadcast Plan </b></h3>
            </div>
            <form method="post" action="{{ url('/') }}/superadmin/plan/updatetelephone" id="vendor_pop" >
            {{ csrf_field() }}
                <input type="hidden" name="plan_id" id="plan_id" value="">
                <div class="modal-body">
                    
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-6 control-label" for="port">Location</label>
                        <div class="col-sm-9 col-lg-6 controls">
                            <input type="text" class="form-control"  name="type" id="type" placeholder="Locatiob" readonly />
                            <div class="error" id="err_loc"></div>
                        </div>
                         <div class="clearfix"></div>
                    </div>

                   <div class="form-group">
                        <label class="col-sm-3 col-lg-6 control-label" for="port">Channels</label>
                        <div class="col-sm-9 col-lg-6 controls">
                ...
                <div style="text-align:left;" class="modal-footer">
                    <div class="col-sm-12">
                        <button class="btn btn-primary" type="submit" name="btn_update_plan_channel" id="btn_update_plan_channel" ><i class="fa fa-check"></i>Save</button>
