...
class Admin extends MY_Controller {
	...
	public function structures(){
		...
		$config['total_rows'] =  $this->smod->get_hospitals($limit, $offset,'total_results', $columns_array); // Total results only.
		

		
		$session_array = array('last_hospital_index_url' => $_SERVER['REDIRECT_URL']);
		$this->session->set_userdata($session_array);
		$this->pagination->initialize($config);
		$data['structures'] = $this->smod->get_hospitals($limit, $offset, '', $columns_array);
		
		$data['pagination_links'] = $this->pagination->create_links();
		$data['columns_array'] = $columns_array;
    ...
    {
		$last_hospital_index_url = $this->session->userdata('last_hospital_index_url');
		//echo "asdf" . $last_hospital_index_url;
        $this->load->library(array('form_validation'));
        $this->form_validation->set_rules('hospital', 'Hospital', 'trim|required|xss_clean');
        $this->form_validation->set_rules('city', 'City', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            $data['last_hospital_index_url'] = $last_hospital_index_url;
